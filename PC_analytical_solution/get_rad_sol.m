...
%     t(t<1e-10)=1e-10;
    ...
    if plotfig==1
        ...
        %add labels
        text(-7.5,-16,'$M$','fontsize',30,'Interpreter','latex');
        text(9,-27,'$K$','fontsize',30,'Interpreter','latex');
        text(0,13,'$\tilde M$','fontsize',30,'Interpreter','latex');
        text(14,-5,'$\tilde K$','fontsize',30,'Interpreter','latex');  
        
        title(['$\tau=$' num2str(tau,3) ' $\phi=$' num2str(phi,3),'Interpreter','latex']);
        ...
        ylabel('$\log_{10}(\phi)$','Interpreter','latex');
